...
import cat.gencat.darp.ervc.service.TagService;
import cat.gencat.darp.ervc.web.rest.errors.BadRequestAlertException;
import cat.gencat.darp.ervc.service.dto.TagDTO;
...
/**
 * REST controller for managing {@link cat.gencat.darp.ervc.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
public class TagResource {
    ...
    private static final String ENTITY_NAME = "microTag";
