...
import cat.gencat.darp.ervc.service.BlogService;
import cat.gencat.darp.ervc.web.rest.errors.BadRequestAlertException;
import cat.gencat.darp.ervc.service.dto.BlogDTO;
...
/**
 * REST controller for managing {@link cat.gencat.darp.ervc.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
public class BlogResource {
    ...
    private static final String ENTITY_NAME = "microBlog";
