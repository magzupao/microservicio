...
import com.micro.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.micro.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
public class EntryResource {
    ...
    private static final String ENTITY_NAME = "microEntry";
