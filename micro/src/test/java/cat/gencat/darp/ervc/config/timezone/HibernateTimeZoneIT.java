package cat.gencat.darp.ervc.config.timezone;

import cat.gencat.darp.ervc.MicroApp;
import cat.gencat.darp.ervc.repository.timezone.DateTimeWrapper;
import cat.gencat.darp.ervc.repository.timezone.DateTimeWrapperRepository;
