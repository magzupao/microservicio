...
export class EntryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.entryService
      ...
      .subscribe(
        (res: HttpResponse<IEntry[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInEntries(): void {
    this.eventSubscriber = this.eventManager.subscribe('entryListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEntry[] | null, headers: HttpHeaders, page: number): void {
